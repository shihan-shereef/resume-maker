            ...
            <div className="auth-page">
                <div className="auth-card">
                    <div className="auth-header">
                        <h1 className="auth-title">{isLogin ? 'Login' : 'Join Takshila'}</h1>
                    ...
                    <div className="auth-oauth-column" style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '24px' }}>
                        <button className="auth-oauth-btn large" onClick={handleGoogleLogin} type="button" style={{ height: '60px', fontSize: '1.1rem' }}>
                        ...
                        <button className="auth-oauth-btn large" onClick={handleGithubLogin} type="button" style={{ height: '60px', fontSize: '1.1rem' }}>
                    ...
                    <div style={{ marginTop: '32px', textAlign: 'center', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
                        ...
                        <p style={{ marginTop: '16px', opacity: 0.7 }}>Secure authentication powered by Supabase Auth.</p>
                    </div>
                </div>
            </div>
        </div>
