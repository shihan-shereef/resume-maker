            ...
            <div className="auth-page">
                <div className="auth-card">
                    ...
                    <div className="auth-oauth-row">
                        <button className="auth-oauth-btn" onClick={handleGoogleLogin} type="button">
                        ...
                        <button className="auth-oauth-btn" onClick={handleGithubLogin} type="button">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="auth-input-wrap">
                            ...
                            <button
                                type="button"
                                className="auth-icon auth-btn-icon"
                        ...
                        <button className="auth-submit-btn" type="submit" disabled={loading}>
                            {loading ? (isLogin ? 'Signing in...' : 'Processing...') : (isLogin ? 'Login' : 'Create Account')}
