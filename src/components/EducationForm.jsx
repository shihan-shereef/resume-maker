            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: window.innerWidth < 480 ? 'column' : 'row', gap: '12px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px', flex: 1 }}>
                        <input className="form-input" style={{ flex: 1 }} type="text" name="startDate" value={item.startDate} onChange={handleChange} placeholder="Start Year" />
                        <input className="form-input" style={{ flex: 1 }} type="text" name="endDate" value={item.endDate} onChange={handleChange} placeholder="End Year / Expected" />
                    </div>
                </div>
